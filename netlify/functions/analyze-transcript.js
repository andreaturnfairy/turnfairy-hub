...
SECTION RULES — assign based on topic:
- Operations: cleaning, maintenance, vendors, Breezeway, Hostaway, lock codes, Ronaldo, linen, check-in/out
- Owners: specific owner names (Rachel, Kathy, Roberto, Nick, Stacey, etc.), property-specific decisions, owner invoices, proposals, Rachel, Josephine
- Team: Penny/VA, SOPs, staff, hiring, internal process, Andrea/Greg/Mike/Lauren roles, training
- Finance: invoices, payments, fees, insurance, QuickBooks, pricing, revenue, P&L, Stripe, Zelle
- Sales: leads, pipeline, new properties, proposals, Josephine, business development, prospects
